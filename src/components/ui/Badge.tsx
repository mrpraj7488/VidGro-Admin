...
const badgeVariants = cva(
  "gaming-badge inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium transition-all duration-300 hover:scale-105",
  {
    variants: {
      variant: {
        ...
        danger: "bg-red-100/80 text-red-800 dark:bg-red-900/50 dark:text-red-300 border-red-300/50 dark:border-red-600/50",
