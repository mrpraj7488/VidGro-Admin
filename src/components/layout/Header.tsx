...
export function Header() {
  return (
    <header className="h-16 bg-white/80 backdrop-blur-xl border-b border-gray-200/60 flex items-center justify-between px-6 shadow-sm dark:bg-slate-900/80 dark:border-slate-700/60">
      <div className="flex items-center space-x-4 flex-1">
        <div className="relative max-w-md">
          <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-4 h-4" />
          <Input
            placeholder="Search users, videos, or analytics..."
            className="pl-10 w-80 bg-white/70 border-gray-200/60 focus:border-violet-300 focus:ring-violet-200 dark:bg-slate-800/70 dark:border-slate-600/60 dark:text-white"
          />
        </div>
      </div>
      
      <div className="flex items-center space-x-3">
        <Button variant="ghost" size="icon" className="relative hover:bg-gray-100/70 dark:hover:bg-slate-800/70">
        ...
        <div className="flex items-center space-x-3 pl-3 border-l border-gray-200/60 dark:border-slate-600/60">
