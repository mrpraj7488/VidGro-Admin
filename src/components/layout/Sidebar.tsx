        ...
        {menuItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              {item.badge && (
                <div className="ml-auto w-5 h-5 bg-gradient-to-r from-red-500 to-red-600 text-white text-xs rounded-full flex items-center justify-center shadow-lg shadow-red-500/50 hidden md:flex lg:flex gaming-pulse gaming-sparkle gaming-shine-enhanced">
