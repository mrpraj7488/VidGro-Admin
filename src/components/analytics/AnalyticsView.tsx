...
export function AnalyticsView() {
  ...
  const hasTopVideos = analyticsData.topVideos && analyticsData.topVideos.length > 0
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
        ...
        <StatsCard
          ...
          value={analyticsData.totalPromoted || 0}
          icon={TrendingUp}
          format="number"
          color="emerald"
        />
        <StatsCard
          ...
          value={analyticsData.videosDeleted || 0}
          icon={Video}
          format="number"
          color="blue"
        />
      ...
      {(hasUserGrowthData || hasCoinTransactionData) && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      {/* Detailed Tables - Only show if we have data */}
      {(hasTopVideos || hasRecentActivity) && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-center py-8 text-gray-500 dark:text-gray-400">
              ...
              <p>Detailed analytics data will be displayed here when available</p>
              <p className="text-sm mt-2">This includes top videos and recent platform activity</p>
            </div>
          </CardContent>
        </Card>
      )}
